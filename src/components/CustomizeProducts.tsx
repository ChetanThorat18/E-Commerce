  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="h-8 w-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-blue-500"></li>
        <li className="h-8 w-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-green-500">
